...
interface IconInstagramProps extends IconProps {}

export default function IconInstagram({ color, size }: IconInstagramProps) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 50 50" color={color}>
